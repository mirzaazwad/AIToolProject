...
from data.schemas.knowledge_base import KnowledgeBase as knowledge_baseSchema
from typing import Dict, List
from lib.errors.tools.knowledge_base import RetrievalError, QueryError, InsertionError, LoadingError
from data.schemas.knowledge_base import KnowledgeEntry
import os
...
class KnowledgeBase(Action):
    ...
    def __init__(self, knowledge_base_file_path: str = "data/knowledge_base.json"):
        """
