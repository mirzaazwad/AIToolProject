...
class ToolLogger(BaseLogger):
    ...
    def log_tool_call(self, tool_name: str, args: dict[str, Union[str, float, int]]) -> None:
    ...
    def log_tool_success(self, tool_name: str, result: str, execution_time: float = 0.0) -> None:
